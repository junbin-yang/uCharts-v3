...
function buildProject() {
  ...
  const h5Dir = path.join(__dirname);
...
function showPublishInfo(version, tag) {
  log('\n🎉 发布完成!', 'green');
  log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━', 'blue');
  log(`📦 包名: ucharts-v3`, 'blue');
  log(`🏷️  版本: ${version}`, 'blue');
  log(`🔖 标签: ${tag}`, 'blue');
  log(`🌐 npm: https://www.npmjs.com/package/ucharts-v3`, 'blue');
  log('━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━', 'blue');
  log('\n📥 安装命令:', 'yellow');
  if (tag === 'latest') {
    log('npm install ucharts-v3', 'green');
  } else {
    log(`npm install ucharts-v3@${tag}`, 'green');
  }
  log('\n📖 使用方法:', 'yellow');
  log('1. HTML引入: <script src="node_modules/ucharts-v3/ucharts-v3.min.js"></script>', 'blue');
  log('2. ES模块: import { H5UCharts } from "ucharts-v3";', 'blue');
