 ...
 * https://tools.ietf.org/html/rfc7946#section-3
 */
export type Geometry = GeoPoint | MultiPoint | LineString | MultiLineString | Polygon | MultiPolygon | GeometryCollection;
 ...
 */
export interface GeoPoint extends GeoJsonObject {
  type: "Point";
...
export type FeatureCollectionFeatures<G extends Geometry | null = Geometry, P = GeoJsonProperties> = FeatureCollection<G, P>["features"];